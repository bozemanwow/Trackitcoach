...
public class Athlete_Report extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        report = (DB_Report) myReport.getParcelable(ReviewByAthleteSelectActivity.ATHLETE_REPORT);
        ...
        sendEmailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(Athlete_Report.this, "There is no email client installed.", Toast.LENGTH_SHORT).show();
                }
            }
        });
